                    ...
                    for (int k = 0; k <= 100; k++)
                    {
                        ...
                        for (int l = 0; l <= 100; l++)
                        {
                            ...
                            int d = Math.Max(0, i * ingredients[0].values["texture"] +
                                                ...
                                                k * ingredients[2].values["texture"] +
                                                l * ingredients[3].values["texture"]);
                            int e = Math.Max(0, i * ingredients[0].values["calories"] +
                                                j * ingredients[1].values["calories"] +
                                                k * ingredients[2].values["calories"] +
                                                l * ingredients[3].values["calories"]);
                            if (e == 500) max = Math.Max(max, a * b * c * d);
                        }
                    }
                }
            }
            Console.WriteLine("Maximum cookie score with 500 calories is " + max);
        }
    }
    class Ingredient
    {
